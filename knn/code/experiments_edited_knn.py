...
type = "classification"
output_file = \
"/home/zacharyproom/IntroML/assignment1/data/breast-cancer-wisconsin_results_edited.csv"
...
for k in k_values:
    ...
    for i in range(5):
        ...
        classifier_a = edited_knn_classifier(k, training_data_a)
        classifier_a.train(validation_data, target_col)
        ...
        classifier_b = edited_knn_classifier(k, training_data_b)
        classifier_b.train(validation_data, target_col)
...
type = "classification"
output_file = "/home/zacharyproom/IntroML/assignment1/data/car_results_edited.csv"
...
type = "classification"
output_file = "/home/zacharyproom/IntroML/assignment1/data/house-votes-84_results_edited.csv"
...
target_col = ["rings"]
type = "regression"
output_file = "/home/zacharyproom/IntroML/assignment1/data/abalone_results_edited.csv"
...
best_threshold = results_df.loc[best_mse_ind, "threshold"]
print("Best k = " + str(best_k))
...
target_col = ["prp"]
type = "regression"
output_file = "/home/zacharyproom/IntroML/assignment1/data/machine_results_edited.csv"
