# hyperparameter_tuning_regularnn.py
# This file is used to tune the number of hidden nodes in the neural networks before comparing all
# the models with 5 x 2 cross-validation. These are the "regular" neural networks (i.e., no 
...
def tune_hyperparameters(file_path, dataset, target_col, type, output_file, h1_list, h2_list):
    ...
    for index, row in results_df.iterrows():
        ...
        for i in range(5):
            ...
            if type == "classification":
                neural_network_classifier_a = neural_network_classifier(training_data, target_col, h1, h2)
                ...
                neural_network_classifier_b = neural_network_classifier(test_data, target_col, h1, h2)
                ...
                neural_network_regressor_a = neural_network_regressor(training_data, target_col, h1, h2)
                neural_network_regressor_a.train()
                predictions_a = neural_network_regressor_a.predict(test_data)
                performance_a = evaluate(eval_type, predictions_a, test_data, target_col)
                
                neural_network_regressor_b = neural_network_regressor(test_data, target_col, h1, h2)
...
target_col = ["class_4"]
type = "classification"
output_file = "/home/zacharyproom/IntroML/assignment3/data/breast-cancer-wisconsin_regularnn_results.csv"
...
type = "classification"
output_file = "/home/zacharyproom/IntroML/assignment3/data/car_regularnn_results.csv"
...
type = "classification"
output_file = "/home/zacharyproom/IntroML/assignment3/data/house-votes-84_regularnn_results.csv"
...
target_col = ["rings"]
type = "regression"
output_file = "/home/zacharyproom/IntroML/assignment3/data/abalone_regularnn_results.csv"
...
target_col = ["prp"]
type = "regression"
output_file = "/home/zacharyproom/IntroML/assignment3/data/machine_regularnn_results.csv"
...
target_col = ["area"]
type = "regression"
output_file = "/home/zacharyproom/IntroML/assignment3/data/forestfires_regularnn_results.csv"
