# autoencoder_based_classifier.py
# This file contains a class that implements autoencoder-based classification.
...
class autoencoder_based_classifier():
    def __init__(self, training_data, target_col, hidden1_size, hidden2_size):
        """This method initializes an autoencoder_based_classifier instance.
    ...
    def train(self, epochs = 1000, learning_rate = 0.01):
        ...
        # Add a classification layer on top of the autoencoder's hidden layer. Train this
        # classification layer, holding the weights in the autoencoder's hidden layer fixed.
